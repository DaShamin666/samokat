...
class TestOrderPage:
    ...
    def test_order_button_top_navigation(self, app,open_main_page):
    ...
    @pytest.mark.smoke
    @allure.severity(allure.severity_level.CRITICAL)
    def test_order_button_bottom_navigation(self, app,open_main_page):
    ...
    @allure.severity(allure.severity_level.CRITICAL)
    def test_fill_order_form_step1_random_user(self, app, test_user,open_main_page, fill_order_form_step1):
    ...
    def test_fill_order_form_step1_predefined_user(self, app,open_main_page, predefined_user, fill_order_form_step1):
    ...
    def test_complete_order_flow(self, app, test_user,open_main_page, complete_order_flow):
        ...
        with allure.step("Проверить успешное оформление заказа"):
            app.order_page.verify_order_success()

    @allure.title("Тестирование с разными типами пользователей")
    @allure.severity(allure.severity_level.NORMAL)
    def test_order_with_different_user_types(self, app, any_user,open_main_page, fill_order_form_step1):
    ...
    def test_metro_station_selection(self, app, test_user,open_main_page, fill_order_form_step1, metro_station):
    ...
    def test_rental_period_selection(self, app, test_user,open_main_page, fill_order_form_step1,
    ...
    @allure.severity(allure.severity_level.CRITICAL)
    def test_required_fields_validation_step1(self, app,open_main_page):
        ...
        with allure.step("Проверить, что форма не отправилась"):
            app.order_page.verify_form_validation_failed()
